...
from backend.processors.imports import get_supabase_client
...
class PipelineProcessor:
    ...
    def __init__(self):
        ...
        self.parts_processor = PartsProcessor(supabase_client=self.supabase)
        self.series_processor = SeriesProcessor(supabase_client=self.supabase)
