-- Migration 13: Create document_products Many-to-Many table
-- NOTE: DROP COLUMN part removed - already handled by Migration 14
...
-- ============================================================================
-- Helper function to get all products for a document
-- ============================================================================
...
-- WHERE proname = 'get_document_products';
