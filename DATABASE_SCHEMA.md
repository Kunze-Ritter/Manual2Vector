...
**Zuletzt aktualisiert:** 06.11.2025 um 09:24 Uhr
...
- [krai_intelligence](#krai-intelligence) (3 Tabellen)
- [krai_content](#krai-content) (3 Tabellen)
- [Public Views (vw_*)](#public-views-vw-)
...
| `page_start` | int4 | YES | - |
| `page_end` | int4 | YES | - |
| `chunk_type` | character varying(50) | YES | 'text'::character varying |
...
| `causes` | jsonb | YES | '[]'::jsonb |
| `solutions` | jsonb | YES | '[]'::jsonb |
| `created_at` | timestamptz | YES | now() |
| `updated_at` | timestamptz | YES | now() |
